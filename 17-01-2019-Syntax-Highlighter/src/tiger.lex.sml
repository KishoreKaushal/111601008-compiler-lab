...
val com_color = "\027[3m\027[4;35m";
val reset_color = "\027[0m";
fun printCommentText(str) = print(com_color ^ str ^ reset_color);
...
fun yyAction1 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (printCommentText(yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction47(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction41(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction41(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ52(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction39(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction43(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction37(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction37(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction44(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction40(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction38(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction38(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction45(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ86(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ25 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction13(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ94(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ93(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction16(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ97(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
...
fun yyQ12 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              then yyQ99(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #"\""
              then if inp = #"\n"
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ98(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"\\"
              then yyQ100(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyQ98(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction6(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ102(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
